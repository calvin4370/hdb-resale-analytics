# ==============================================================================
# SCRIPT:  02b_validation.R
# PURPOSE: Validate the geocoded coordinates generated by 02_geocoding.R
# AUTHOR:  Chan Jun Jie
# DATE:    2025-12-02
# ==============================================================================
...
# Load coordinates generated from 02_geocoding.R
coords <- read_csv("data/external/hdb_coordinates.csv")
head(coords)
